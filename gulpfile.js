...
//     .pipe(sass({ errLogToConsole: true, imagePath: 'app/public/' }))
//     // .pipe(cssImageDimensions('../public/images'))
//     // .on('error', onError)
//     .pipe(inline_base64({
//         baseDir: 'app/public/',
//         maxSize: 14 * 1024,
...
gulp.task('sass', function () {
  gulp.src('app/scss/**/*.scss')
    ...
    .pipe(sass({imagePath: 'app/public/'}).on('error', sass.logError))
    .pipe(sourcemaps.write())
    .pipe(cssImageDimensions('app/public/images'))
    .pipe(inline_base64({baseDir: 'app/public/', maxSize: 14 * 1024, debug: false }))
